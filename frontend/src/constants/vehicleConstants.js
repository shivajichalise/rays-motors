...
export const VEHICLE_COMPARE_DETAILS_REQUEST = 'VEHICLE_COMPARE_DETAILS_REQUEST'
export const VEHICLE_COMPARE_DETAILS_SUCCESS = 'VEHICLE_COMPARE_DETAILS_SUCCESS'
export const VEHICLE_COMPARE_DETAILS_FAIL = 'VEHICLE_COMPARE_DETAILS_FAIL'
